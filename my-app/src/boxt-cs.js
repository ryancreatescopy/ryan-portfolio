    ...
    <Box>
      <Box borderBottom={1} borderWidth="1px" borderColor="#F8F8F9"width="100%" zIndex="99999" bg="white" position="fixed" color="white" >
        ...
        <Box display={["block", "block", "block", "none"]} alignItems="center">
          <Flex borderTop={1} borderWidth="1px" borderColor="#F8F8F9" bg="white" alignItems="center" width="100%" position="fixed" bottom="0" justifyContent="flex-end" pt={3} pb={3}>
            <Flex>
              <Link style={{ color: 'inherit', textDecoration: 'inherit'}} to="/DeliverooCS"><Button.Outline mainColor="text" borderRadius="16px" border={1} borderWidth="2px" borderColor="#9498F7" mr={4}>Previous</Button.Outline></Link>
            </Flex>
          <Link style={{ color: 'inherit', textDecoration: 'inherit'}} to="/"><Button.Outline mainColor="text" borderRadius="16px" border={1} borderWidth="2px" borderColor="#9498F7" mr={4}>Next</Button.Outline></Link>
          </Flex>
        </Box>
      </Box>
      <Box pt="80px">
      ...
      <Box display={["none", "none", "none", "block"]} alignItems="center">
        <Flex mt={5} alignItems="center" width="100%" position="fixed" justifyContent="space-between" pt={3} pb={3}>
          <Flex>
            <Link style={{ color: 'inherit', textDecoration: 'inherit'}} to="/DeliverooCS"><Button.Outline icon="ArrowBack" mainColor="text" borderRadius="8px" border={1} borderWidth="2px" borderColor="#9498F7" size="small" mx={[4, 4, "64px"]}>Previous</Button.Outline></Link>
          </Flex>
        <Link style={{ color: 'inherit', textDecoration: 'inherit'}} to="/"><Button.Outline icon="ArrowForward" iconpos="right" mainColor="text" borderRadius="8px" border={1} borderWidth="2px" borderColor="#9498F7" size="small" mx={[4, 4, "64px"]}>Next</Button.Outline></Link>
        </Flex>
      </Box>
      <Container>
          <Box>
          ...
          >
            With summer fast approaching in their first year of operations, boiler startup BOXT wanted to increase the conversion rate of their website to see them through the toastier summer months. My team undertook a project to make incremental data-driven UX improvements to their sales funnel to help make that happen.
          </Text>
          ...
          <Box mt={5} ml={["0", "-56px"]}>
            ...
            <Flex>
              ...
              <Flex justifyContent="center" flexDirection="column" pb="40px">
                ...
                <Caption>This canvas helped us properly frame our experiments and get buy in from stakeholders.</Caption>
              </Flex>
            </Flex>
            <Flex>
              <ArrowForward color="#777C8C" size="40px" mr={3}/>
              <Flex justifyContent="center" flexDirection="column" pb="40px">
                ...
                <Caption>The task I asked participants to complete. I used a highlighter test to assess how well the content helped push users through the flow. Green for helpful content, red for anything that didn’t help or was confusing.</Caption>
                ...
                <Caption>The all-in-one checkout experience we designed and tested, 4 years later.</Caption>
              </Flex>
            </Flex>
          </Box>
        </Container>
