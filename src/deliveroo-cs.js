    ...
    <Box>
      <Box borderBottom={1} borderWidth="1px" borderColor="#F8F8F9"width="100%" zIndex="99999" bg="white" position="fixed" color="white" >
        ...
        <Box display={["block", "block", "block", "none"]} alignItems="center">
          <Flex borderTop={1} borderWidth="1px" borderColor="#F8F8F9" bg="white" alignItems="center" width="100%" position="fixed" bottom="0" justifyContent="flex-end" pt={3} pb={3}>
            <Flex>
              <Link style={{ color: 'inherit', textDecoration: 'inherit'}} to="/CodefiCS"><Button.Outline mainColor="text" borderRadius="16px" border={1} borderWidth="2px" borderColor="#9498F7" mr={4}>Previous</Button.Outline></Link>
            </Flex>
          <Link style={{ color: 'inherit', textDecoration: 'inherit'}} to="/BoxtCS"><Button.Outline mainColor="text" borderRadius="16px" border={1} borderWidth="2px" borderColor="#9498F7" mr={4}>Next</Button.Outline></Link>
          </Flex>
        </Box>
      </Box>
      <Box pt="80px">
      ...
      <Box display={["none", "none", "none", "block"]} alignItems="center">
        <Flex mt={5} alignItems="center" width="100%" position="fixed" justifyContent="space-between" pt={3} pb={3}>
          <Flex>
            <Link style={{ color: 'inherit', textDecoration: 'inherit'}} to="/CodefiCS"><Button.Outline icon="ArrowBack" mainColor="text" borderRadius="8px" border={1} borderWidth="2px" borderColor="#9498F7" size="small" mx={[4, 4, "64px"]}>Previous</Button.Outline></Link>
          </Flex>
        <Link style={{ color: 'inherit', textDecoration: 'inherit'}} to="/BoxtCS"><Button.Outline icon="ArrowForward" iconpos="right" mainColor="text" borderRadius="8px" border={1} borderWidth="2px" borderColor="#9498F7" size="small" mx={[4, 4, "64px"]}>Next</Button.Outline></Link>
        </Flex>
      </Box>
      <Container>
          <Box>
          ...
          >
            Creating menus was one of the most costly parts of Deliveroo operations. A large majority of this work was outsourced and time-consuming leading to a not insignificant amount of human error. Many restaurants wanted the ability to make quick edits to their menu whenever they wanted and resented having to go via their account manager. My team’s task was to remove this business overhead and solve this user need.
          </Text>
          ...
          <Box mt={5} ml={["0", "-56px"]}>
              ...
              <Flex justifyContent="center" flexDirection="column" pb="40px">
                ...
                <Text fontSize={["20px", "24px"]} mt="40px" color="#1A2233">
                  <ul>
                    ...
                    <li><strong>Owner-manager</strong> – sole or part business owner who also runs the restaurant and is financially liable</li>
            ...
            <Flex>
              ...
              <Flex justifyContent="center" flexDirection="column" pb="40px">
                ...
                <Image mt="40px" src="/cs-images/conversational-design.png" />
              </Flex>
            </Flex>
            <Flex>
              <ArrowForward color="#777C8C" size="40px" mr={3}/>
            ...
            <Flex>
              ...
              <Flex justifyContent="center" flexDirection="column" pb="40px">
                ...
                <Caption>An excerpt from the research report on how well the MVP performed with internal users.</Caption>
                <Image mt="40px" src="/cs-images/menus-sketching.png" />
                <Caption>Sketches the product designer and I made in the Berlin office inbetween testing sessions. Patterns were already emerging about the need to bulk manage items while also persistently being able to see the in-progress menu. This formed our vision for the next iteration.</Caption>
              </Flex>
            </Flex>
            <Flex>
              <ArrowForward color="#777C8C" size="40px" mr={3}/>
              <Flex justifyContent="center" flexDirection="column" pb="40px">
                ...
                <Caption>Users could make all the edits they needed in an auto-generated Google sheet. They then import and send it fo the restaurant to approve, passing the liability onto them.</Caption>
                <Image mt="40px" src="/cs-images/food-safety-publish.png" />
                <Caption>If information was missing, we’d flag it and explain what needs to be fixed before a menu could be published onto the Deliveroo platform.</Caption>
              </Flex>
            </Flex>
          </Box>
