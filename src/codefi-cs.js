    ...
    <Box>
      ...
      <Container>
          <Box>
            ...
            <Flex justifyContent="center">
              <Text color="#475166" fontSize={["24px", "40px"]} mb={[4, 5]}>Codefi wanted a design system to help them bring all their products under the Codefi brand look and feel and reduce significant duplication of effort that was going on between their many product teams. We (the Rimble team) were tasked with starting a design system to help.</Text>
            </Flex>
            <Text color="text" fontSize={["20px", "24px"]} mb={[5, 6]}>Unfortunately this product was cut short due to Corona virus redundancies, but I still learned and achieved plenty that I think is worth documenting.</Text>
          </Box>
          ...
          <Box mt={5} ml={["0", "-56px"]}>
            <Flex>
              ...
              <Flex justifyContent="center" flexDirection="column" pb="40px">
                <Text lineHeight={1} fontSize={["32px", "40px"]} color="#1A2233" mb={2}>Pick a project</Text>
            ...
            <Flex>
              <ArrowForward color="#777C8C" size="40px" mr={3}/>
              <Flex justifyContent="center" flexDirection="column" pb="40px">
                <Text lineHeight={1} fontSize={["32px", "40px"]} color="#1A2233" mb={2}>Collaborate with other designers</Text>
                <Text fontSize={["20px", "24px"]} mt="24px" color="#1A2233">
            ...
            <Flex>
              <ArrowForward color="#777C8C" size="40px" mr={3}/>
              <Flex justifyContent="center" flexDirection="column" pb="40px">
                <Text lineHeight={1} fontSize={["32px", "40px"]} color="#1A2233" mb={2}>Document!</Text>
                <Text fontSize={["20px", "24px"]} mt="24px" color="#1A2233">
        ...
        <Box mt={5} ml={["0", "-56px"]}>
          <Flex>
            ...
            <Flex justifyContent="center" flexDirection="column">
              <Text lineHeight={1} fontSize={["32px", "40px"]} color="#1A2233" mb={2}>Sell, sell, sell</Text>
              <Text fontSize={["20px", "24px"]} mt="24px" color="#1A2233">My main strategy for selling the design system was explaining how it laddered up to the organisation’s main objectives. By framing it in business rationale, it was hard to argue with. </Text>
          ...
          <Flex>
            <ArrowForward color="#777C8C" size="40px" mr={3}/>
            <Flex justifyContent="center" flexDirection="column">
              <Text lineHeight={1} fontSize={["32px", "40px"]} color="#1A2233" mb={2}>Design the service</Text>
              <Text fontSize={["20px", "24px"]} mt="24px" color="#1A2233">
